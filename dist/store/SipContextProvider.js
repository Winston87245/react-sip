...
class ce extends Error {
  constructor(e, t, r, s) {
    super(), this.message = e, this.expected = t, this.found = r, this.location = s, this.name = "SyntaxError", typeof Object.setPrototypeOf == "function" ? Object.setPrototypeOf(this, ce.prototype) : this.__proto__ = ce.prototype, typeof Error.captureStackTrace == "function" && Error.captureStackTrace(this, ce);
  }
...
`, !1),
    ...
    function() {
      e = e || { data: {} }, e.data.user = decodeURIComponent(y().slice(0, -1));
    },
    function() {
      e = e || { data: {} }, e.data.password = y();
    },
    function() {
      return e = e || { data: {} }, e.data.host = y(), e.data.host;
    },
    function() {
      return e = e || { data: {} }, e.data.host_type = "domain", y();
    },
    /^[a-zA-Z0-9_\-]/,
    C([["a", "z"], ["A", "Z"], ["0", "9"], "_", "-"], !1, !1),
    /^[a-zA-Z0-9\-]/,
    C([["a", "z"], ["A", "Z"], ["0", "9"], "-"], !1, !1),
    function() {
      return e = e || { data: {} }, e.data.host_type = "IPv6", y();
    },
    "::",
    l("::", !1),
    function() {
    ...
    function() {
      return e = e || { data: {} }, e.data.host_type = "IPv4", y();
    },
    "25",
    l("25", !1),
    /^[0-5]/,
    ...
    l("//", !1),
    function() {
      e = e || { data: {} }, e.data.scheme = y();
    },
    l("SIP", !0),
    function() {
      e = e || { data: {} }, e.data.sip_version = y();
    },
    "INVITE",
    l("INVITE", !1),
    "ACK",
    ...
    l("PUBLISH", !1),
    function() {
      return e = e || { data: {} }, e.data.method = y(), e.data.method;
    },
    function(h) {
      e = e || { data: {} }, e.data.status_code = parseInt(h.join(""));
    },
    function() {
      e = e || { data: {} }, e.data.reason_phrase = y();
    },
    function() {
      e = e || { data: {} }, e.data = y();
    },
    ...
    function(h) {
      h = y().trim(), h[0] === '"' && (h = h.substring(1, h.length - 1)), e = e || { data: {} }, e.data.displayName = h;
    },
    "q",
    l("q", !0),
    function(h) {
    ...
    l("alert", !0),
    function() {
      e = e || { data: {} }, e.startRule === "Content_Disposition" && (e.data.type = y().toLowerCase());
    },
    "handling",
    l("handling", !0),
    "optional",
...
class Ke {
  ...
  addHeader(e, t) {
    const r = { raw: t };
    e = Z(e), this.headers[e] ? this.headers[e].push(r) : this.headers[e] = [r];
  }
  /**
...
class ae {
  constructor(e, t, r, s, i, n, o) {
    this.headers = {}, this.extraHeaders = [], this.options = ae.getDefaultOptions(), i && (this.options = Object.assign(Object.assign({}, this.options), i), this.options.optionTags && this.options.optionTags.length && (this.options.optionTags = this.options.optionTags.slice()), this.options.routeSet && this.options.routeSet.length && (this.options.routeSet = this.options.routeSet.slice())), n && n.length && (this.extraHeaders = n.slice()), o && (this.body = {
      body: o.content,
      contentType: o.contentType
    }), this.method = e, this.ruri = t.clone(), this.fromURI = r.clone(), this.fromTag = this.options.fromTag ? this.options.fromTag : $e(), this.from = ae.makeNameAddrHeader(this.fromURI, this.options.fromDisplayName, this.fromTag), this.toURI = s.clone(), this.toTag = this.options.toTag, this.to = ae.makeNameAddrHeader(this.toURI, this.options.toDisplayName, this.toTag), this.callId = this.options.callId ? this.options.callId : this.options.callIdPrefix + ne(15), this.cseq = this.options.cseq, this.setHeader("route", this.options.routeSet), this.setHeader("via", ""), this.setHeader("to", this.to.toString()), this.setHeader("from", this.from.toString()), this.setHeader("cseq", this.cseq + " " + this.method), this.setHeader("call-id", this.callId), this.setHeader("max-forwards", "70");
  }
...
`, this.body ? typeof this.body == "string" ? (e += "Content-Length: " + we(this.body) + `\r
\r
`, e += this.body) : this.body.body && this.body.contentType ? (e += "Content-Type: " + this.body.contentType + `\r
`, e += "Content-Length: " + we(this.body.body) + `\r
\r
...
class he {
   ...
   */
  constructor(e, t = {}) {
    this.pendingReinvite = !1, this.pendingReinviteAck = !1, this._state = p.Initial, this.delegate = t.delegate, this._stateEventEmitter = new me(), this._userAgent = e;
  }
  /**
   * Destructor.
   */
  ...
  invite(e = {}) {
    ...
    if (this.pendingReinvite)
      return Promise.reject(new pe("Reinvite in progress. Please wait until complete, then try again."));
  ...
  getOffer(e) {
    ...
    try {
      return t.getDescription(r, s).then((i) => xe(i)).catch((i) => {
  ...
  setOfferAndGetAnswer(e, t) {
    ...
    try {
      return r.setDescription(e.content, s, i).then(() => r.getDescription(s, i)).then((n) => xe(n)).catch((n) => {
...
class ge extends he {
  ...
  reject(e = {}) {
    ...
    if (t < 300 || t > 699)
      throw new TypeError("Invalid statusCode: " + t);
    const i = e.body ? xe(e.body) : void 0;
   ...
   */
  sendProgress(e = {}) {
    const t = e.statusCode || 180, r = e.reasonPhrase, s = (e.extraHeaders || []).slice(), i = e.body ? xe(e.body) : void 0;
    if (t === 183 && !i)
  ...
  sendProgressReliableWaitForPrack(e = {}) {
    ...
    return new Promise((o, d) => {
      this.waitingForPrack = !0, this.generateResponseOfferAnswer(this.incomingInviteRequest, t).then((m) => (n = m, this.incomingInviteRequest.progress({ statusCode: r, reasonPhrase: s, extraHeaders: i, body: n }))).then((m) => {
        ...
        const I = setTimeout(() => {
          this.waitingForPrack && (this.waitingForPrack = !1, this.logger.warn("No PRACK received, rejecting INVITE."), clearTimeout(W), this.reject({ statusCode: 504 }).then(() => d(new De())).catch((l) => d(l)));
        }, q.T1 * 64), D = () => {
          try {
            this.incomingInviteRequest.progress({ statusCode: r, reasonPhrase: s, extraHeaders: i, body: n });
          } catch (l) {
            this.waitingForPrack = !1, d(l);
            return;
          }
          W = setTimeout(D, y *= 2);
        };
        let y = q.T1, W = setTimeout(D, y);
      }).catch((m) => {
...
class be extends he {
  ...
  notifyReferer(e) {
    if (!this._referred)
      return;
    if (!(this._referred instanceof he))
...
class J {
   ...
   */
  constructor(e, t = {}) {
    this.disposed = !1, this._contacts = [], this._retryAfter = void 0, this._state = S.Initial, this._waiting = !1, this._stateEventEmitter = new me(), this._waitingEventEmitter = new me(), this.userAgent = e;
    const r = e.configuration.uri.clone();
    if (r.user = void 0, this.options = Object.assign(Object.assign(Object.assign({}, J.defaultOptions()), { registrar: r }), J.stripUndefinedProperties(t)), this.options.extraContactHeaderParams = (this.options.extraContactHeaderParams || []).slice(), this.options.extraHeaders = (this.options.extraHeaders || []).slice(), !this.options.registrar)
    ...
    if (this.request = e.userAgentCore.makeOutgoingRequestMessage(b.REGISTER, s, i, n, o, d, void 0), this.expires = this.options.expires || J.defaultExpires, this.expires < 0)
  ...
  dispose() {
    return this.disposed ? Promise.resolve() : (this.disposed = !0, this.logger.log(`Registerer ${this.id} in state ${this.state} is being disposed`), delete this.userAgent._registerers[this.id], new Promise((e) => {
      const t = () => {
        if (!this.waiting && this._state === S.Registered) {
  ...
  register(e = {}) {
    ...
    if (this.waiting) {
      this.waitingWarning();
      const s = new pe("REGISTER request already in progress, waiting for final response");
  ...
  unregister(e = {}) {
    if (this.state === S.Terminated)
      throw this.stateError(), new Error("Registerer terminated. Unable to register.");
    if (this.disposed && this.state !== S.Registered)
      throw this.stateError(), new Error("Registerer disposed. Unable to register.");
    if (this.waiting) {
      this.waitingWarning();
      const s = new pe("REGISTER request already in progress, waiting for final response");
    ...
    this._state !== S.Registered && !e.all && this.logger.warn("Not currently registered, but sending an unregister anyway.");
  ...
  registered(e) {
    ...
    }, e * 1e3), this._state !== S.Registered && this.stateTransition(S.Registered);
  }
  /**
   * Helper function, called when unregistered.
   */
  unregistered() {
    this.clearTimers(), this._state !== S.Unregistered && this.stateTransition(S.Unregistered);
  }
  /**
   * Helper function, called when terminated.
   */
  terminated() {
    this.clearTimers(), this._state !== S.Terminated && this.stateTransition(S.Terminated);
  }
  /**
  ...
  stateTransition(e) {
    ...
    switch (this._state) {
      case S.Initial:
        e !== S.Registered && e !== S.Unregistered && e !== S.Terminated && t();
        break;
      case S.Registered:
        e !== S.Unregistered && e !== S.Terminated && t();
        break;
      case S.Unregistered:
        e !== S.Registered && e !== S.Terminated && t();
        break;
      case S.Terminated:
        t();
        break;
    ...
    this._state = e, this.logger.log(`Registration transitioned to state ${this._state}`), this._stateEventEmitter.emit(this._state), e === S.Terminated && this.dispose();
  }
  ...
  /** Hopefully helpful as the standard behavior has been found to be unexpected. */
  stateError() {
    let t = `An attempt was made to send a REGISTER request when the Registerer ${this.state === S.Terminated ? "is in 'Terminated' state" : "has been disposed"}.`;
...
class Rt {
  ...
  authenticate(e, t, r) {
    ...
    if (t.qop)
      ...
      this.qop = void 0;
    return this.method = e.method, this.uri = e.ruri, this.cnonce = ne(12), this.nc += 1, this.updateNcHex(), this.nc === 4294967296 && (this.nc = 1, this.ncHex = "00000001"), this.calculateResponse(r), !0;
  }
  /**
  ...
  calculateResponse(e) {
    let t, r;
    t = this.ha1, (t === "" || t === void 0) && (t = ee(this.username + ":" + this.realm + ":" + this.password)), this.qop === "auth" ? (r = ee(this.method + ":" + this.uri), this.response = ee(t + ":" + this.nonce + ":" + this.ncHex + ":" + this.cnonce + ":auth:" + r)) : this.qop === "auth-int" ? (r = ee(this.method + ":" + this.uri + ":" + ee(e || "")), this.response = ee(t + ":" + this.nonce + ":" + this.ncHex + ":" + this.cnonce + ":auth-int:" + r)) : this.qop === void 0 && (r = ee(this.method + ":" + this.uri), this.response = ee(t + ":" + this.nonce + ":" + r));
  }
}
var k;
(function(a) {
...
class Ce extends ze {
  constructor(e, t, r, s, i) {
    super(t, r, Ce.makeId(e), s, i), this._request = e, this.user = r, e.setViaHeader(this.id, t.protocol);
  }
  static makeId(e) {
    if (e.method === "CANCEL") {
      if (!e.branch)
...
class X {
  constructor(e, t, r, s) {
    this.transactionConstructor = e, this.core = t, this.message = r, this.delegate = s, this.logger = this.loggerFactory.getLogger("sip.user-agent-server"), this.toTag = r.toTag ? r.toTag : $e(), this.init();
  }
  dispose() {
    this.transaction.dispose();
  }
...
class ye extends le {
  ...
  signalingStateTransition(e) {
    const t = fe(e);
    if (!(!t || t.contentDisposition !== "session")) {
      if (this._signalingState === T.Stable && (this._rollbackOffer = this._offer, this._rollbackAnswer = this._answer), e instanceof de)
      ...
      case /^1[0-9]{2}$/.test(t):
        {
          ...
          const s = le.initialDialogStateForUserAgentClient(this.message, e);
          let i = this.earlyDialogs.get(s.id);
          if (!i) {
            const o = this.transaction;
            if (!(o instanceof se))
              throw new Error("Transaction not instance of InviteClientTransaction.");
            i = new ye(o, this.core, s), this.earlyDialogs.set(i.id, i);
          }
      ...
      case /^2[0-9]{2}$/.test(t):
        {
          ...
          if (i = this.earlyDialogs.get(s.id), i)
            ...
            if (!(o instanceof se))
              throw new Error("Transaction not instance of InviteClientTransaction.");
            i = new ye(o, this.core, s), this.confirmedDialogs.set(i.id, i);
          }
          (i.signalingState === T.Initial || i.signalingState === T.HaveLocalOffer) && i.signalingStateTransition(e);
          const n = i;
...
class ke extends X {
  ...
  accept(e = { statusCode: 200 }) {
    ...
    if (!this.confirmedDialog)
      if (this.earlyDialog)
        ...
        if (!(d instanceof N))
          throw new Error("Transaction not instance of InviteClientTransaction.");
        const m = le.initialDialogStateForUserAgentServer(this.message, this.toTag);
        this.confirmedDialog = new ye(d, this.core, m);
      }
    const t = this.message.getHeaders("record-route").map((d) => `Record-Route: ${d}`), r = `Contact: ${this.core.configuration.contact.toString()}`, s = "Allow: " + re.toString();
    if (!e.body) {
  ...
  progress(e = { statusCode: 180 }) {
    ...
    if (!this.earlyDialog) {
      ...
      if (!(o instanceof N))
        throw new Error("Transaction not instance of InviteClientTransaction.");
      const d = le.initialDialogStateForUserAgentServer(this.message, this.toTag, !0);
      this.earlyDialog = new ye(o, this.core, d);
    }
...
class Vt {
  ...
  receiveInsideDialogRequest(e) {
    ...
    if (r) {
      if (e.method === b.OPTIONS) {
        const s = "Allow: " + re.toString(), i = "Accept: " + Ve.toString();
        this.replyStateless(e, {
          statusCode: 200,
          extraHeaders: [s, i]
        });
  ...
  receiveOutsideDialogRequest(e) {
    switch (e.method) {
      ...
      case b.OPTIONS:
        {
          const t = "Allow: " + re.toString(), r = "Accept: " + Ve.toString();
          this.replyStateless(e, {
            statusCode: 200,
            extraHeaders: [t, r]
          });
...
class ve {
  constructor(e, t) {
    if (this._state = x.Disconnected, this.transitioningState = !1, this._stateEventEmitter = new me(), this.logger = e, t) {
...
`);
  ...
  transitionLoopDetectedError(e) {
    ...
    return t += ` An attempt to transition from ${this._state} to ${e} before the prior transition completed.`, t += " Perhaps you are synchronously calling connect() or disconnect() from a callback or state change handler?", this.logger.error(t), new ue("Loop detected.");
  }
  /**
...
class G {
   ...
   */
  constructor(e = {}) {
    if (this._publishers = {}, this._registerers = {}, this._sessions = {}, this._subscriptions = {}, this._state = H.Stopped, this._stateEventEmitter = new me(), this.delegate = e.delegate, this.options = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, G.defaultOptions()), { sipjsId: ne(5) }), { uri: new z("sip", "anonymous." + ne(6), "anonymous.invalid") }), { viaHost: ne(12) + ".invalid" }), G.stripUndefinedProperties(e)), this.options.hackIpInContact)
   ...
   */
  initContact() {
    const e = this.options.contactName !== "" ? this.options.contactName : ne(8), t = this.options.contactParams;
    return {
      pubGruu: void 0,
      tempGruu: void 0,
  ...
  onTransportMessage(e) {
    ...
    if (this.state === H.Stopped && t instanceof de) {
    ...
    if (t instanceof de) {
      ...
      const s = we(t.body), i = t.getHeader("content-length");
      if (i && s < Number(i)) {
...
class Me {
  ...
  constructor(e, t = {}) {
    ...
    if (r.transportConstructor || (r.transportConstructor = ve), r.transportOptions || (r.transportOptions = {
      server: e
    }), !r.uri && t.aor) {
  ...
  async call(e, t, r) {
    ...
    const n = new be(this.userAgent, i, t);
   ...
   */
  async decline(e) {
    return this.logger.log(`[${e.id}] Rejecting Invitation...`), this.sessionExists(e) ? e instanceof ge ? e.reject() : Promise.reject(new Error("Session not instance of Invitation.")) : Promise.reject(new Error("Session does not exist."));
  }
  /**
   * Hold call
...
Duration=` + 2e3
  ...
  async transfer(e, t, r) {
    if (this.logger.log(`[${e.id}] Referring session...`), t instanceof he)
    ...
    return new Promise((s, i) => {
      this.registrationAttemptTimeout = setTimeout(() => {
        t().then(() => {
          ...
          this.registrationAttemptTimeout = void 0, n instanceof pe ? s() : i(n);
        });
...
`, 2);
  ...
  async setHold(e, t) {
    ...
    return n.held = t, e.invite(s).then(() => {
      ...
      throw n.held = !t, o instanceof pe && this.logger.error(`[${e.id}] A hold request is already in progress.`), o;
    });
  }
  /**
    ...
    return l.delegate = {
      ...
      onCallReceived: () => {
        r(
          "ringing"
          /* ringing */
        ), y(), console.log("Call received");
      },
      onCallHangup: () => {
        r(
          "idle"
          /* idle */
        ), W(), console.log("Call hung up");
      },
      onCallHold: (U) => {
        console.log(`Call ${U ? "held" : "resumed"}`);
      },
      onCallDTMFReceived: (U, Te) => {
        console.log(`DTMF received: ${U} for ${Te}ms`);
      },
      onMessageReceived: (U) => {
        console.log(`Message received: ${U}`);
      },
      onRegistered: () => {
      ...
      onServerDisconnect: (U) => {
        r(
          "error"
          /* error */
        ), console.error("Disconnected from server", U);
      }
    }, (async () => {
      r(
        "connecting"
      ...
      try {
        await l.connect(), await l.register(), r(
          "idle"
          /* idle */
        );
      } catch (U) {
